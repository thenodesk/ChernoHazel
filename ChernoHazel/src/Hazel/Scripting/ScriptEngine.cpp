...
namespace Hazel {
    ...
    namespace Utils {
        ...
        static MonoAssembly* LoadMonoAssembly(const std::filesystem::path& assemblyPath, bool loadPDB = false)
        {
            ...
            // NOTE: We can't use this image for anything other than loading the assembly because this image doesn't have a reference to the asset
    ...
    static void OnAppAssemblyFileSystemEvent(const std::string& path, const filewatch::Event event_type)
    {
        if (!s_Data->AssemblyReloadPending && event_type == filewatch::Event::modified)
        {
    ...
    void ScriptEngine::LoadAppAssembly(const std::filesystem::path& filepath)
    {
        ...
        if (!s_Data->AppAssemblyFileWatcher)
