...
IncludeDir["filewatch"] = "%{wks.location}/ChernoHazel/vendor/filewatch"
...
IncludeDir["mono"] = "%{wks.location}/ChernoHazel/vendor/mono/include"
...
LibraryDir["mono"] = "%{wks.location}/ChernoHazel/vendor/mono/lib/%{cfg.buildcfg}"
